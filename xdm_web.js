...
client.on('message_create', async (msg) => {
    ...
    `);
            ...
            // } else if (msg.fromMe && msg.body === '!pin') {
            //     const chat = await msg.getChat();
            //     await chat.pin();
            // } else if (msg.fromMe && msg.body === '!archive') {
            //     const chat = await msg.getChat();
            //     await chat.archive();
            // } else if (msg.fromMe && msg.body === '!mute') {
            //     const chat = await msg.getChat();
            //     // mute the chat for 20 seconds
            //     const unmuteDate = new Date();
            //     unmuteDate.setSeconds(unmuteDate.getSeconds() + 20);
            //     await chat.mute(unmuteDate);
            // } else if (msg.fromMe && msg.body === '!typing') {
            //     const chat = await msg.getChat();
            //     // simulates typing in the chat
            //     chat.sendStateTyping();
            // } else if (msg.fromMe && msg.body === '!recording') {
            //     const chat = await msg.getChat();
            //     // simulates recording audio in the chat
            //     chat.sendStateRecording();
            // } else if (msg.fromMe && msg.body === '!clearstate') {
            //     const chat = await msg.getChat();
            //     // stops typing or recording in the chat
            //     chat.clearState();
            // } else if (msg.fromMe && msg.body === '!jumpto') {
            //     if (msg.hasQuotedMsg) {
            //         const quotedMsg = await msg.getQuotedMessage();
            ...
            //     msg.react('👍');
            // } else if (msg.fromMe && msg.body === '!edit') {
            //     if (msg.hasQuotedMsg) {
            //         const quotedMsg = await msg.getQuotedMessage();
            //         if (quotedMsg.fromMe) {
            ...
            //         }
            //     }
            // } else if (msg.fromMe && msg.body === '!updatelabels') {
            //     const chat = await msg.getChat();
            //     await chat.changeLabels([0, 1]);
            // } else if (msg.fromMe && msg.body === '!addlabels') {
            //     const chat = await msg.getChat();
            //     let labels = (await chat.getLabels()).map(l => l.id);
            //     labels.push('0');
            //     labels.push('1');
            //     await chat.changeLabels(labels);
            // } else if (msg.fromMe && msg.body === '!removelabels') {
            //     const chat = await msg.getChat();
            ...
            getCommands(msg);
            // } else if (msg.body.toLowerCase() === ('!content')) {
            //     contentEditMode = true;
            //     currentContent = '';
            //     msg.reply('In Content Writing Mode..');
            // } else if (msg.body.toLowerCase() === ('!edit')) {
            //     contentEditMode = false;
            //     var author = msg.from;
            //     if (author.includes('@g.us')) {
            //         author = msg.author;
            //     }
            //     sendCommand(msg, author, currentContent);
            // } else if (msg.body.slice(0, 15).includes(':')) {
        } else if (msg.body.startsWith('@')) {
...
// function createAuthor(msg, id, name, number) {
//     var authorData = {};
//     authorData['id'] = id;
//     authorData['number'] = number;
//     authorData['name'] = name;
//     postR(`author/${number}`, msg, authorData);
// }
...
//     notification.reply(greatingMsg);
//     // notification.reply('');
// });
...
// I:xdm:18
// l:xdm:18
// function putR(headers, body) { }

// function deleteR(headers, body) { }
...
//         // options[msgHostKey] = host;
//         // options[msgPortKey] = port;
//         // var jsonMap = JSON.parse(msg.body);
//         // var destination = jsonMap[msgUrlKey];
//         // var headers = jsonMap[msgHeadersKey];
//         // var method = jsonMap[msgMethodKey];
//         // var body = jsonMap[msgBodyKey];
...
//             client.interface.openChatWindowAt(quotedMsg.id._serialized);
//         }
//     } else if (msg.fromMe && msg.body === '!buttons') {
//         let button = new Buttons('Button body', [{ body: 'bt1' }, { body: 'bt2' }, { body: 'bt3' }], 'title', 'footer');
//         client.sendMessage(msg.from, button);
//     } else if (msg.fromMe && msg.body === '!list') {
//         let sections = [{ title: 'sectionTitle', rows: [{ title: 'ListItem1', description: 'desc' }, { title: 'ListItem2' }] }];
//         let list = new List('List body', 'btnText', sections, 'Title', 'footer');
//         client.sendMessage(msg.from, list);
//     } else if (msg.fromMe && msg.body === '!reaction') {
//         msg.react('👍');
//     } else if (msg.fromMe && msg.body === '!edit') {
//         if (msg.hasQuotedMsg) {
//             const quotedMsg = await msg.getQuotedMessage();
